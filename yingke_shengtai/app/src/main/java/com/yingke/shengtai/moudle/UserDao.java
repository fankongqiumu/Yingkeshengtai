...
import com.yingke.shengtai.db.DemoDBManager;
...
public class UserDao {
	...
	public static final String TABLE_NAME_INFOR = "uerinfor";
	...
	/**
	 * 获取好友listsssssssssssssssssssss
	 *
	 * @return
	 */
	public Map<String, User> getContactMapss() {

		return DemoDBManager.getInstance().getContactMap();
	}

	/**
	 * 保存一个联系人ssssssssssssssssssss
	 * @param user
	 */
	public void saveContactsss(User user){
		DemoDBManager.getInstance().saveContactData(user);
	}
